...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/lexm_8")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/lexm_8"),
            InlineKeyboardButton(text="🛠️ Repo", url="owner-se-baat-karle"),
        ],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [{CREDIT}](https://t.me/lexm_8)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
